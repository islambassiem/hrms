			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
              <img alt="user-img" class="avatar avatar-xl brround" src="{{ Auth::user()->avatar() }}">
              <span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0">{{ Auth::user()->empid }}</h4>
							<span class="mb-0 text-muted">{{ Str::before(Auth::user()->email, "@") }}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
