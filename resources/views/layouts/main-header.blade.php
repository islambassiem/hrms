			...
			<div class="main-header sticky side-header nav nav-item">
				<div class="container-fluid">
					...
					<div class="main-header-right">
							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/lang.png')}}" alt="img"></span>
										<div class="my-auto">
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="#" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/ar.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2 mx-1">{{ __('Arabic') }}</span>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex">
											<span class="avatar ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/en.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2 mx-1">{{ __('English') }}</span>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex">
											<span class="avatar ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/ph.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2 mx-1">{{ __('Philipines') }}</span>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/in.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2 mx-1">{{ __('Indian') }}</span>
											</div>
										</a>
									</div>
								</div>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/'.Auth::user()->empid.'.jpeg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/faces/'.Auth::user()->empid.'.jpeg')}}" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{ Str::before(Auth::user()->email, '@') }}</h6><span>{{ Auth::user()->empid }}</span>
											</div>
										</div>
									</div>
                  ...
                  <form method="POST" action="{{ route('logout') }}">
                    ...
                    this.closest('form').submit();"><i class="bx bx-log-out"></i> {{ __('Sign Out') }}</a>
                </form>
